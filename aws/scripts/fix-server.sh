...
# 3. Fix File Permissions for Nginx (www-data)
echo "🔒 Fixing file permissions..."
sudo chmod 755 /home/ubuntu
sudo chmod -R 755 "$APP_DIR/client/build"

# 4. Remove default Nginx site and link customer-report
